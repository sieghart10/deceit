...
def predict(text, class_counts, class_word_counts, vocab_size, model_config, is_log=False):
    ...
    if is_log:
        print(f"Tokens (including n-grams): {tokens[:10]}...")  # Show first 10
...
if __name__ == "__main__":
    ...
    # Configuration flags
    TRAIN = True
    COMPARE_MODELS = True  # Set to True to compare different n-gram configurations
    ...
    VERSION = 1
    FILEPATH = f"bow_naive_bayes_model{VERSION}{version_suffix}.pkl"
